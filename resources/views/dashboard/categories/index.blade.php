  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{ __('messages.categories_table') }}</h1>
            <a href="{{ route('categories.create') }}" style="margin-top: 30px; " class="btn btn-primary">{{ __('messages.create_cat') }}</a>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('messages.home') }}</a></li>
              <li class="breadcrumb-item active">{{ __('messages.categories_table') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 150px;">
                    ...
                    <div class="input-group-append">
                      ...
                      <a href="{{ route('categories.index') }}" class="btn btn-default" form="form-search">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{  $cat->name }}</td>
                      <td>
                        <a href="{{ route('categories.edit', $cat->id) }}" class="btn btn-primary">{{ __('messages.edit') }}</a>
          ...
          {{-- Pagination Links --}}
        @include('inc.paginator', ['paginator' => $cats])
        {{-- {{ $cities->links() }} --}}
        </div>
        <!-- /.row -->
        {{-- <div class="row">
